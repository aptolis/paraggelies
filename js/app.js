...
function goSummary() {
  ...
  if (notesVal) {
    html += `<div class="sum-zone" style="border-color:#94a3b8"><div class="sum-zone-hdr" style="background:#f1f5f9;border-bottom:0.5px solid #cbd5e1"><i class="ti ti-notes" style="color:#64748b"></i> <span style="color:#475569">Σημειωσεις / Εκκρεμοτητες</span></div><div class="sum-body"><div style="font-size:13px;color:#333;white-space:pre-wrap;padding:4px 0">${notesVal}</div></div></div>`;
  }
...
function copyOrder() {
  ...
  if (cur && cur.pendingItems && cur.pendingItems.length) {
    txt += '=== ΕΚΚΡΕΜΟΤΗΤΕΣ (αναμενουν επιβεβαιωση) ===\n';
