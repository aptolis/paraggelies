    ...
    return `<div style="padding:10px 12px;border-bottom:0.5px solid var(--color-border);background:${already ? '#f0faf5' : '#fff'}">
      <div style="display:flex;align-items:flex-start;gap:8px;margin-bottom:8px">
        ...
        <div style="flex:1;min-width:0">
          <div style="font-size:15px;font-weight:600;color:#1a1a1a;line-height:1.3">${p.name}
            ${already ? '<span class="badge b-hist" style="font-size:10px">ιστορικό</span>' : ''}
            ${isPending ? '<span class="badge" style="background:#FEF3C7;color:#D97706;border:1px solid #FCD34D;font-size:10px">εκκρεμεί</span>' : ''}
          </div>
      ...
      <div style="display:flex;gap:6px">
        <button onclick="quickAddPending('${p.id}')"
          ...
          <i class="ti ti-clock" style="font-size:12px"></i> Εκκρεμότητα
        </button>
        <button onclick="quickAdd('${p.id}')"
          ...
          <i class="ti ti-history" style="font-size:12px"></i> ${already ? 'Ενεργοποίηση' : 'Παραγγελία / Ιστορικό'}
        </button>
      </div>
    </div>`;
  }).join('');
